# BOLT‑EAR Starter Pack

A minimal, buildable scaffold to bring up an RBM accelerator with optional on‑FPGA CD‑1 training on PYNQ‑Z1.

> Copy files according to the paths below. Synthesize with Vivado 2023.1. Start with *PL‑only* design; add PS/PYNQ later.
